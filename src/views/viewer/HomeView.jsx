...
import { 
  ...
  BookOpen, Info, Heart, Image as ImageIcon, Users, ShoppingBag 
} from 'lucide-react';
...
return (
    <div className="space-y-8 max-w-5xl mx-auto pb-6 pt-4">
      ...
      {/* 2. EXPLORE PLAYER MARKET CTA CARD (Emerald Accent) */}
      <div className="px-2 sm:px-0">
          <div 
            onClick={() => {
            ...
            <div className="flex items-center gap-4 w-full sm:w-auto">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-400">Available Now</span>
                </div>
                <h3 className="text-lg md:text-xl font-extrabold text-white tracking-tight">Explore Player Market</h3>
                <p className="text-xs md:text-sm text-slate-400 mt-0.5">Scout the official ZBSM Elite Cup 2026 roster.</p>
              </div>
            </div>
